...
from .discretization import divergence, pressure_gradient
...
def build_gmg_solver(
    ...
    *,
    ...
    applied matrix-free with :func:`~jaxwind.discretization.divergence` and
    :func:`~jaxwind.discretization.pressure_gradient` instead of a sparse
